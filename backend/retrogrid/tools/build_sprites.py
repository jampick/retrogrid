...
from ..providers.league import make_league
from ..providers.slate import load_pool, load_slate

OUT = paths.SPRITES
RAW = paths.HEADSHOTS
SIZE = 96
POOL_TOP = 320                 # sprites built when no fantasy league picks the players for us
...
async def run(argv: list[str] | None = None) -> None:
    ...
    async with httpx.AsyncClient(headers={"User-Agent": "Mozilla/5.0 RetroGrid sprite batch"}) as client:
