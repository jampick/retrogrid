...
Writes data/live/ in the same shape build_slate.py writes data/slate/ — games
...
season's finished weeks, restricted to active players on teams playing today.
    ...
    RETROFFB_SEASON=2026 .venv/bin/python scripts/fetch_nflverse.py --force
...
from build_slate import defence_points, player_points  # noqa: E402
from retroffb.providers.directory import TEAM_NAMES  # noqa: E402
from retroffb.providers.espn import SITE, parse_utc, scoreboard_games, season_week  # noqa: E402
